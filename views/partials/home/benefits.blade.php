    ...
    <div class="container">
        <div class="two-items-carousel owl-carousel">
            <div class="image-and-text-box animate fadeInLeft">
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img1.jpg') }}" alt=""></a></div>
            ...
            <div class="image-and-text-box animate fadeInRight">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut labore. Love life’s sweetest reward Let it flow it floats back to you.</p>
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img2.jpg') }}" alt=""></a></div>
            </div>
            <div class="image-and-text-box">
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img3.jpg') }}" alt=""></a></div>
            ...
            <div class="image-and-text-box">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut labore. Love life’s sweetest reward Let it flow it floats back to you.</p>
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img4.jpg') }}" alt=""></a></div>
            </div>
            <div class="image-and-text-box">
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img5.jpg') }}" alt=""></a></div>
            ...
            <div class="image-and-text-box">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adi pisi cing elit, sed do eiusmod tempor exercitationemut labore. Love life’s sweetest reward Let it flow it floats back to you.</p>
                <div class="bordered-thumb"><a href="services.html"><img src="{{ Theme::url('images/img6.jpg') }}" alt=""></a></div>
            </div>
        </div>
    </div>
</section><!-- / BENIFITS -->