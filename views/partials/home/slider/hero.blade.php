        ...
        <nav class="container">
            ...
            <ul>
                <li class="selected"><a href="#0">
                        ...
                        Money Care<span>Finding your Next Advisor</span></a></li>
                <li><a href="#0">
                        <div class="slide-number">2</div>
                        Friendly Assistance<span>Export Financial Advice</span></a></li>
                <li><a href="#0">
                        <div class="slide-number">3</div>
                        Our Experience<span>We have 15 Years Experience</span></a></li>
                <li><a href="#0">
                        <div class="slide-number">4</div>
                        Client Investment<span>Doing the right thing</span></a></li>
            </ul>
        </nav>
    </div>
