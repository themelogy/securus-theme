...
<section class="meet-our-advisors">
    <div class="container">
        ...
        <div class="single-item-carousel owl-carousel classic-arrows">
            <div class="row">
                <div class="col-md-5 animate fadeInLeft"><img src="{{ Theme::url('images/meet-our-advisors-img1.jpg') }}" alt=""></div>
            ...
            <div class="row">
                <div class="col-md-5"><img src="{{ Theme::url('images/meet-our-advisors-img2.jpg') }}" alt=""></div>
                <div class="col-md-7">
                    <div class="meet-advisors-content">
            ...
            <div class="row">
                <div class="col-md-5"><img src="{{ Theme::url('images/meet-our-advisors-img3.jpg') }}" alt=""></div>
                <div class="col-md-7">
                    <div class="meet-advisors-content">
